...
namespace GodotTools.Internals
{
    public static class GodotSharpDirs
    {
        ...
        private static void DetermineProjectLocation()
        {
            ...
            _projectAssemblyName = ProjectSettings.GetSetting("dotnet/project/assembly_name").AsString();
            ...
            string slnParentDir = ProjectSettings.GetSetting("dotnet/project/solution_directory").AsString();
            if (string.IsNullOrEmpty(slnParentDir))
                slnParentDir = "res://";

            string csprojParentDir = ProjectSettings.GetSetting("dotnet/project/c#_project_directory").AsString();
